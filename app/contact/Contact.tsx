...
const Contact: React.FC<PropertiesClientProps> = ({}) => {
  // Rendu du composant
  return (
    <Container>
      <section
          ...
          <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
            <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
              ...
              <p className="text-lg md:text-xl text-coolGray-500 font-medium">
                Il n&apos;a jamais été aussi facile de rester en contact avec
                Casas. Appelez-nous, utilisez notre numéro de téléphone ou
                envoyez-nous un e-mail, et nous vous répondrons dans les
                meilleurs délais !
              </p>
            </div>
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full md:w-1/2 px-4 mb-10">
                  <div className="max-w-xs mx-auto">
                    <div className="inline-flex mb-6 items-center justify-center w-12 h-12 bg-gradient-to-r from-yellow-200 via-cyan-200 to-sky-500 rounded-full">
                      <svg
